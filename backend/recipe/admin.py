...
from .models import Recipe, RecipeTag, RecipeIngredient, Favorite, Basket
...
class RecipeAdmin(admin.ModelAdmin):
    ...
    list_filter = ('tags',)
    fields = ('name', 'author', 'cooking_time', 'text', 'image', 'favorite_count', 'basket_count')
    ...
    def favorite_count(self, obj):
        """Возвращает общее количество пользователей, добавивших рецепт в избранное."""
